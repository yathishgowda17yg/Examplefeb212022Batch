...
public class ModifyCustomerDemo {
	...
	private static void createCustomer()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.id("customerLightBox_nameField")).sendKeys("DemoUser1");
			Thread.sleep(2000);
	...
	private static void modifyCustomer()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//*[@id=\"taskListBlock\"]/div[1]/div[1]/div[2]")).sendKeys("Sampleuser");
			Thread.sleep(2000);
